...
@RestController
@RequestMapping("/api/you-code-kafka")
public class YouCodeKafkaResource {
    private final Logger log = LoggerFactory.getLogger(YouCodeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public YouCodeKafkaResource(KafkaProperties kafkaProperties) {
